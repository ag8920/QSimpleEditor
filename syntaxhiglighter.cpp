...
void syntaxHiglighter::highlightBlock(const QString &str)
{
        ...
        if(nState==InsideCStyleComment){
            ...
            if(str.mid(i,2)=="//"){
                ...
                if(!strKeyword.isEmpty()){
                    setFormat(i,strKeyword.length(),Qt::green);
...
QString syntaxHiglighter::getKeyword(int nPos, const QString &str) const
{
    QString strTemp="";
